...
export async function adminCreateUser(req: CreateUserRequest): Promise<UserDto> {
  const payload = {
    email: req.email,
...
export async function adminSetUserEnabled(userId: number, enabled: boolean): Promise<UserDto> {
